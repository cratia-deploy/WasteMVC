...
namespace WasteMVC.Controllers
{
    public class PartnersController : Controller
    {
        ...
        public PartnersController(SystemContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("Percentage,Id")] Partner partner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Percentage,Id")] Partner partner)
        {
            if (id != partner.Id)
            {
                return NotFound();
